...
const OTTO_PLUS_RELEASE = {
  versionCode: 7,
  versionName: '1.5.1',
  apkUrl: 'https://github.com/kakmese/pawcal-website/releases/download/ottoplus-v1.5.1/otto-plus-v1.5.1.apk',
  notlar: 'Otto+ 1.5.1 - hata duzeltmeleri ve kararlilik iyilestirmeleri',
  zorunlu: false,
};
