      ...
      <section className="pt-32 pb-16 bg-[var(--bg-secondary)]">
        <Container>
          <div className="text-center">
            <Badge variant="primary" className="mb-4">✍️ {t('badge')}</Badge>
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {blogPosts.map((post) => {
              ...
              return (
                <article key={slug} className="glass rounded-3xl overflow-hidden group hover:border-[#FF8F6B]/30 transition-all duration-300">
                  {/* Placeholder image */}
