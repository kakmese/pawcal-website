...
const OTTO_PLUS_APK_URL =
  'https://github.com/kakmese/pawcal-website/releases/download/ottoplus-v1.5.1/otto-plus-v1.5.1.apk';
...
export default function OttoPlusIndirPage() {
  const [versionName, setVersionName] = useState<string | null>('1.5.1');
